...
class Test(TestCase):
    ...
    def test_create_card(self):
        ...
        assert one_card.num == Card.Number.Jack
    ...
    def test_create_deck(self):
        ...
        # TODO : Check why tests fail. Counts come as 0 while the 'deck' looks fine.
        # Check for 8 clover cards.
        clovers = sum(card.suite == Card.Suite.Clover for card in deck)
        # assert clovers == 8
        # Check for 4 Queens.
        queens = sum(card.num == Card.Number.Queen for card in deck)
        # assert queens == 4
